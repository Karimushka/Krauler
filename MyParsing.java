...
public class MyParsing { // Систему и класс парсинга я нагло спер у коллеги. Да Простит он меня за это.
    ...
    public Map <String,Integer> countOfWords(String url) throws IOException{
        ...
        // перебор всех элементов коллекции c гарантированным сохранением порядка элементов, с использованием лямбда выражения в качестве операции по заполнению мапы с генерацией ключа
        return mapOfWords;
    }
